...
export const TechStack: FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <article className="relative flex-1 rounded-xl border border-zinc-400 p-4 text-center duration-300 after:absolute after:-left-[1px] after:top-8 after:h-20 after:w-[2px] after:bg-gradient-to-t after:from-transparent after:via-sky-500 after:to-transparent after: transition-all after:content-[''] hover:after:top-32 dark:border-slate-50/20 dark:after:via-rose-500 sm:col-span-2 md:col-span-1">
